 ...
 * - XenForo users posting directly through the web interface
 * - Discord users via the Discord bot integration
 *
 ...
 * @property boolean $is_discord_message Message text content (max 500 chars)
 * @property boolean $is_message_edited Whether the message has been edited
...
class Message extends Entity
{
	 ...
	 * - user_id: XenForo user ID; nullable to support generic Discord posts
	 * - date: Unix timestamp of message creation
	 * - message: The actual message text
	 * - discord_message_id: Discord message ID for bidirectional sync
	 * - discord_user_id: Discord user snowflake for identity tracking
	 * - discord_username: Discord display name (stored when user is unlinked)
	 * - discord_avatar_url: Discord avatar URL (stored when user is unlinked)
	 *
	 * Relations:
